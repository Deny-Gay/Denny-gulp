...
exports.default = series(clean, parallel(htmlInclude, scripts, fonts, resources, phpMailer, imgToApp, webpImages, svgSprites), fontsStyle, styles, watchFiles);
...
exports.build = series(clean, parallel(htmlInclude, scriptsBuild, fonts, resources, phpMailer, imgToApp, webpImages, svgSprites), fontsStyle, stylesBuild, htmlMinify, imagesBuild, cache, rewrite);
